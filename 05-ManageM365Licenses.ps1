...
#####################################################################################
##                                                                                 ##
##  Program           05ManageM365Licenses.ps1                                     ##
##  Author            O365reports.com/ Jeff Canfield / Chris Johnston              ##
##  CreateDt          20240901                                                     ##
##  Description       This program has multiple functions listed below.            ##
##                    We will use it to assign E3 M365 licenses. 	               ##
##  Usage             1. run .\05ManageM365Licenses.ps1                            ##
##                    2. Verify that the text file LicenseFriendlyName.txt         ##
##                    exists in your local C:\Code\repository name directory       ##
##                    3. Please choose the action to continue: 6 	        	   ##
##		              Bulk:Assign a license to users (input CSV)                   ##
##		              4. Enter the CSV file containing user			               ##
##		              names(Eg:D:/UserNames.txt): enter the path to your CSV	   ##
##                      Eg: C:\CSV\Sandbox\CCB\userstolicense.csv                  ##
##                    5. Enter the license name(Eg:Enterprisepack): Enterprisepack ##
##  Inputs            CSV specified with a list users in one column:               ##
##		              *** NO COLUMN HEADER REQUIRED ***                            ##
##                         eg. jsmith@supplyone.com				                   ##
##			                   ksmith@supplyone.com                                ##
##		                                                                           ##
##		                                                                           ##
#####################################################################################
#####################################################################################
