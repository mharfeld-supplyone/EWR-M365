...
#####################################################################################
##                                                                                 ##
##  Program           26-DisableSourceAccountloginsandrevoketokens .ps1            ##
##  Author            Jeff Canfield / Chris Johnston                               ##
##  CreateDt          20240901                                                     ##
##  Description       This program disables user accounts and revokes tokens 	   ##
##                    at the source tenant. Typically ran at the start             ##
##		              of migration weekend. 					                   ##
...
##                    4. run .\26-DisableSourceAccountloginsandrevoketokens .ps1   ##
