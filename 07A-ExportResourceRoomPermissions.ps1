...
#####################################################################################
##                                                                                 ##
##  Program           07A-ExportResourceRoomPermissions.ps1                        ##
##  Author            Jeff Canfield / Chris Johnston                               ##
##  CreateDt          20240901                                                     ##
##  Description       This program exports a CSV with Room mailbox permissions 	   ##
##		              on the source tenant     				                       ##
##  Usage             1. Connect-ExchangeOnline       			                   ##
##                    2. verify Log folder "C:\Temp" exists 		               ##
##                    3. run .\07A-ExportResourceRoomPermissions.ps1               ##
...
$resourceRooms = Get-Mailbox -RecipientTypeDetails RoomMailbox 
...
foreach ($mailbox in $resourceRooms) { 
    ...
    $sendOnBehalfPermissions = Get-RecipientPermission -Identity $mailbox.Identity -AccessRights SendOnBehalf 
